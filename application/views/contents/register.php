        ...
        <div class="mdl-card__supporting-text color--dark-gray">
          ...
          <form class="" action="<?php echo base_url('register/doregister')?>" method="post">
            ...
            <div class="mdl-grid">
              ...
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                <span class="login-name text-color--white">Registro de Usuario</span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                ...
                <span class="login-link">Estoy de acuerdo con todas las declaraciones en los <a href="#" class="underlined">terminos y condiciones del servicio</a></span>
              </div>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                <a href="<?php echo base_url('login')?>" class="login-link">Ya estoy registrado. Iniciar Sesión</a>
